...
public class ProductRESTController {
    ...
    public ResponseEntity<List<Product>> findProductsByCriteria(FindProductsByCriteria findProductsCriteria) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "The specified product " + findProductsCriteria.getName() + " does not exist.", e);
        }
    }
    ...
    public ResponseEntity<Boolean> deleteProduct(@PathVariable @NotNull Long productId) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "The specified product category " + productId + " does not exist.", e);
        }
    }
}
